...
public class BizPluginManager {
    ...
    public static final int MSG_PLUGIN_INSTALL_FIN = 1; // 插件下载完成
    public static final int MSG_PLUGIN_UNINSTALL_FIN = 2; // 插件卸载完成
    ...
    public void installPlugin(Plugin plugin) {
        application.installPlugin(plugin);
        dispatchMessage(MSG_PLUGIN_INSTALL_FIN);
    }
    ...
    public void uninstallPlugin(Plugin plugin) {
        application.uninstallPlugin(plugin);
        dispatchMessage(MSG_PLUGIN_UNINSTALL_FIN);
    }
