...
public class Cache {
	...
	public void put(String key, String value, int saveTime) {
		put(key, CacheUtil.newStringWithDateInfo(saveTime, value));
	}
	...
	public String getAsString(String key) {
		...
		try {
			...
			if (!CacheUtil.isDue(readString)) {
				return CacheUtil.clearDateInfo(readString);
			} else {
				removeFile = true;
				return null;
			}
	...
	public void put(String key, byte[] value, int saveTime) {
		put(key, CacheUtil.newByteArrayWithDateInfo(saveTime, value));
	}
	...
	public byte[] getAsBinary(String key) {
		...
		try {
			...
			if (!CacheUtil.isDue(byteArray)) {
				return CacheUtil.clearDateInfo(byteArray);
			} else {
				removeFile = true;
				return null;
			}
	...
	public void put(String key, Bitmap value) {
		put(key, CacheUtil.Bitmap2Bytes(value));
	}
	...
	public void put(String key, Bitmap value, int saveTime) {
		put(key, CacheUtil.Bitmap2Bytes(value), saveTime);
	}
	...
	public Bitmap getAsBitmap(String key) {
		...
		return CacheUtil.Bytes2Bimap(getAsBinary(key));
	}
	...
	public void put(String key, Drawable value) {
		put(key, CacheUtil.drawable2Bitmap(value));
	}
	...
	public void put(String key, Drawable value, int saveTime) {
		put(key, CacheUtil.drawable2Bitmap(value), saveTime);
	}
	...
	public Drawable getAsDrawable(String key) {
		...
		return CacheUtil.bitmap2Drawable(CacheUtil.Bytes2Bimap(getAsBinary(key)));
	}
