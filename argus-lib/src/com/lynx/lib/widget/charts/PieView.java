...
public class PieView extends View {
	...
	private void drawBackground(Canvas canvas) {
		...
		canvas.drawText("18", leftTextWidth / 2, pieCenterPoint.y + textRect.height() / 2,
				textPaint);
		canvas.drawText("6", mViewWidth - rightTextWidth / 2, pieCenterPoint.y + textRect.height()
				/ 2, textPaint);
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		cirRect.set(pieCenterPoint.x - pieRadius, pieCenterPoint.y - pieRadius, pieCenterPoint.x
				+ pieRadius, pieCenterPoint.y + pieRadius);
